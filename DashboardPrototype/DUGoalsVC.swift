...
class DUGoalsVC: UIViewController {
...
extension DUGoalsVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        // case 0:
            // let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "goalsCollectionViewCell1", for: indexPath) as! GoalsCollectionViewCellLayout2
//            cell.imageView.image = UIImage(named: "goalbg")
            
            // return cell;
            
        case 1:
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "goalsCollectionViewCell2", for: indexPath) as! GoalsCollectionViewCellLayout2
        ...
        default:
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "goalsCollectionViewCell3", for: indexPath) as! GoalsCollectionViewCellLayout2
    ...
    func configWeekView(_ cell: GoalsCollectionViewCellLayout2, color: UIColor) {
...
class GoalsCollectionViewCellLayout2: UICollectionViewCell {
